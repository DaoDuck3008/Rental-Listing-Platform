...
import { createListingType } from "@/services/listingType.api";
...
export default function CreateListingTypePage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const res = await createListingType(form);
      setIsSubmitting(false);

      if (res.success) {
        toast.success("Tạo loại bài đăng thành công!");
  ...
  return (
    <>
        ...
        <div className="max-w-240 mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-text-secondary text-base">
              Định nghĩa kiểu bất động sản mới cho hệ thống.
            </p>
          </div>
      ...
      {isSubmitting && <LoadingOverlay message="Đang tạo loại bài đăng..." />}
    </>
  );
}
